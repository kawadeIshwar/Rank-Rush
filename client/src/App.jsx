...
<div className="grid grid-cols-1 xl:grid-cols-[400px_1fr] gap-8 items-start">
  ...
  <div
    ref={leaderboardRef}
    className="order-1 xl:order-2 bg-dark-bg rounded-2xl p-6 border border-border hover:shadow-xl transition-shadow duration-300 flex flex-col"
  >
  ...
  {/* Left column (Game Controls + History) */}
